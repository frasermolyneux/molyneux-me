locals {
  workload_resource_groups = data.terraform_remote_state.platform_workloads.outputs.workload_resource_groups[var.workload_name][var.environment].resource_groups
  workload_resource_group  = local.workload_resource_groups[lower(var.location)]
